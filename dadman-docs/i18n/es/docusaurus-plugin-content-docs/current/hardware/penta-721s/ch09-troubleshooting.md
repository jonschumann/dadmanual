...
\| Unidad no descubierta por DADman | Comprobar cable Ethernet y conexión de conmutadores. Verificar que el host NIC está en la misma subred. Verifique los ajustes de QoS en el interruptor administrado. | [Ch. 3 — Instalación](./ch03-installation#34-network-setup) |
\| Interruptor de red de audio en Ethernet | Se requiere un conmutador de red dedicado — no compartir con tráfico de TI. Comprueba la configuración de QoS. | [Ch. 3 — Instalación](./ch03-installation) |
