...
El AX64 es una unidad de montaje en rack de 2U que se monta directamente en un rack estándar de 19-inch con las orejas de rack suministradas.
...
Interno. IEC C14 inlet. 100–240 V AC, 50/60 Hz, auto-ranging. PSU redundante opcional disponible.
...
4. Conecte la unidad al ordenador anfitrión (Thunderbolt 3 o Ethernet).
