...
El AX64 soporta múltiples fuentes de referencia de reloj. La fuente de reloj activa está seleccionada en DADman. Sólo un dispositivo en una sesión DADman debe ser el maestro del reloj; todos los demás dispositivos deben esclavizarlo.
...
1. En DADman, abra la Configuración del dispositivo para la AX64.
