...
El Penta 720 es una unidad de montaje en rack 2U (chasis modulares) que se monta directamente en un estante estándar de 19 inch con las orejas de rack suministradas.
...
Interno. IEC C14 inlet. 100–240 V AC, 50/60 Hz, 0.45–0.20 A. PSU redundante opcional.
