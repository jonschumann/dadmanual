...
El centro AX soporta múltiples fuentes de referencia de relojes. La fuente de reloj activa está seleccionada en DADman. Sólo un dispositivo en una sesión DADman debe ser el maestro del reloj; todos los demás dispositivos deben esclavizarlo.
...
1. En DADman, abra la Configuración del Dispositivo para el Centro AX.
