...
> **SKU:** CORE256-BASE  
> **Fuente:** Especifica hoja CORE256-BASE, número junio 2026
...
| ------------------------- | ------- | --------------------------- |
| Tensión de entrada        | 12 V DC | Suministro externo incluido |
| Máximo consumo de energía | 60 W    |                             |
...
| Parámetro       | Valor                                                                    |
| --------------- | ------------------------------------------------------------------------ |
| Factor de forma | Montura de escritorio / 1RU (con C256-2MOUNT-BRACKET) |
| Width           | 21.1 cm / 8.3"                           |
| Profundidad     | 23.1 cm / 9.1"                           |
| Peso            | 1.3 kg / 2.9 lbs                         |
