...
The Core 256 is a half-rack unit. A 1U rack shelf (available separately) or the Core 256 Racking Hardware accessory is required to mount it in a standard 19-inch rack.
...
External. 12 V DC barrel connector. External PSU supplied.
