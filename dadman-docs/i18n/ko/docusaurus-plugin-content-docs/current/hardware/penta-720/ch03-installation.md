...
The Penta 720 is a 2U rackmount (modular chassis) unit that mounts directly in a standard 19-inch rack with the supplied rack ears.
...
Internal. IEC C14 inlet. 100–240 V AC, 50/60 Hz, 0.45–0.20 A. Optional redundant PSU.
...
_[Placeholder — network configuration procedure. Cross-reference to DADman manual Ch. 3.]_
