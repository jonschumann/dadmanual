...
> _[Placeholder — replace all TBC values with verified pin data from engineering.]_
...
_[Placeholder — 25-pin D-sub pinout for the Tascam/ELCO standard used on DAD expansion cards and Penta AES connectors.]_
...
TOSLINK connectors carry optical digital audio. No pin assignment — observe the transmit (Tx) / receive (Rx) orientation marked on the panel.
