...
_Figure 2.1 — AX 64 front panel. Numbered callouts correspond to the table below._
...
_Figure 2.2 — AX 64 rear panel. Numbered callouts correspond to the table below._
...
| 1a     | _(Optional)_              | IEC C14 inlet                            | Redundant power supply inlet (factory-fitted option).                                                                                                                                                                                                                                                            | <span style={{display:'inline-block',width:'10px',height:'10px',borderRadius:'50%',margin:'0 6px',background:'#0891B2'}}></span> |
