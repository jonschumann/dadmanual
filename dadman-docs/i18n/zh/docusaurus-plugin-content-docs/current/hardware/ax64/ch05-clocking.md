...
The AX64 supports multiple clock reference sources. The active clock source is selected in DADman. Only one device in a DADman session should be the clock master; all other devices should slave to it.
...
1. In DADman, open the Device Configuration for the AX64.
