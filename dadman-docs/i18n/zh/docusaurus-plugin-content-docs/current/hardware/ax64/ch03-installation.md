...
_[Placeholder — environmental requirements: temperature, humidity, ventilation clearance.]_
...
_[Placeholder — rack mounting procedure. Include racking hardware part numbers and torque specifications.]_

The AX64 is a 2U rackmount unit that mounts directly in a standard 19-inch rack with the supplied rack ears.
...
_[Placeholder — power connection procedure.]_

Internal. IEC C14 inlet. 100–240 V AC, 50/60 Hz, auto-ranging. Optional redundant PSU available.
...
## 3.4 Thunderbolt Driver Installation

The DAD Thunderbolt driver must be installed on the host computer before the unit will be detected by DADman.

_[Placeholder — driver installation procedure. Cross-reference to DADman manual Ch. 3.]_

1. Download the DAD Thunderbolt driver package from [digitalaudio.dk](https://digitalaudio.dk/support).
2. Run the installer and follow the on-screen instructions.
3. Restart the computer when prompted.
4. Power on the unit and connect the Thunderbolt cable.
5. Open DADman — the unit should appear in the Device List.

> **NOTICE:** Thunderbolt security settings on macOS may require the user to approve the new Thunderbolt device on first connection. See the DADman Installation chapter for details.

---

## 3.5 Initial Startup

_[Placeholder — first-power procedure and verification steps.]_
...
4. Connect the unit to the host computer (Thunderbolt 3 or Ethernet).
