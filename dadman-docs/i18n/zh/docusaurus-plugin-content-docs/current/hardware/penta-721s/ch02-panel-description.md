...
_Figure 2.1 — Penta 721s front panel. Numbered callouts correspond to the reference table below._
...
_Figure 2.2 — Penta 721s rear panel. Numbered callouts correspond to the table below._
...
| 13  | **SLOT 1** _(typical: Dante/AES67 I/O)_ | 2× SFP                                  | Expansion card slot 1. When fitted with a Dante/AES67 I/O card: two SFP ports for optical or copper Dante network connections. | Cyan   |
