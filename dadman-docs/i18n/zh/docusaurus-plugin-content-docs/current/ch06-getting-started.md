...
Clicking a section header button collapses or expands that section _(v5.7.2 and later)_. This is useful on smaller screens or when working with multiple units simultaneously.

_[Placeholder: annotated screenshot — DADman main window showing all five tabs, Device List, and unit border colour]_
...
_[Placeholder: screenshot — DADman main window at launch with empty Device List]_
...
_[Placeholder: screenshot — Device List showing one connected AX Center with coloured border]_
...
_[Placeholder: screenshot — AD tab with two mic channels configured, Signal LED lit]_
...
_[Placeholder: screenshot — Con tab with crosspoints connected showing overview and detail matrix]_
...
_[Placeholder: screenshot — DA tab with output level faders set]_
...
_[Placeholder: screenshot — Mon tab with a monitor profile loaded]_
...
_[Pending: screenshots for Steps 1, 2, 4, 5, 6, 7, 9 — all require an AX Center connected to DADman v5.8.2]_
