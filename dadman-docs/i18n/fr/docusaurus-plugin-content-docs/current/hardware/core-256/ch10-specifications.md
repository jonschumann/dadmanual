...
> **REF :** CORE256-BASE  
> **Source :** Feuille de spécification CORE256-BASE, Problème Juin 2026
...
| -------------------------- | ------- | ---------------------------- |
| Tension d'entrée           | 12 V DC | Alimentation externe incluse |
...
| Paramètre             | Valeur                                                                                    |
| --------------------- | ----------------------------------------------------------------------------------------- |
| Facteur de formulaire | Ordinateur de bureau / 1RU rackmount (avec option C256-2MOUNT-BRACKET) |
| Width                 | 21.1 cm / 8.3"                                            |
| Profondeur            | 23.1 cm / 9.1"                                            |
...
## 10.11 Conformité réglementaire
