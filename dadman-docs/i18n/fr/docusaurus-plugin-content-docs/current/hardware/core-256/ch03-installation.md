...
Le Core 256 est un demi-rack. Une étagère 1U (disponible séparément) ou l'accessoire de quincaillerie Core 256 est nécessaire pour le monter dans un rack standard de 19 pouces.
...
Externe. Connecteur de canon DC 12 V. PPS externe fourni.
