...
Le AX Center est une unité de montage en rack de 1U qui se monte directement dans un rack de 19 pouces standard avec les oreilles de rack fournies.
...
Internal. IEC C14 inlet. 100-240 V AC, 50/60 Hz, auto-rangement.
...
4. Connectez l'unité à l'ordinateur hôte (Thunderbolt 3).
