...
AX64 understøtter flere ur-referencekilder. Den aktive urkilde er valgt i DADman. Kun én enhed i en DADman-session bør være ur master; alle andre enheder bør slave til det.
...
1. I DADman åbnes enhedskonfigurationen for AX64.
