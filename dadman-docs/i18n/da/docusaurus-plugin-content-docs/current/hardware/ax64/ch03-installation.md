...
AX64 er en 2U rackmount enhed, der monteres direkte i en standard 19-tommer rack med de medfølgende rack ører.
...
Internal. IEC C14 inlet. 100–240 V AC, 50/60 Hz, auto-ranging. Valgfri overflødig PSU tilgængelig.
...
DAD Thunderbolt driveren skal installeres på værtscomputeren, før enheden vil blive opdaget af DADman.

_[Pladsholder — chauffør monteringsprocedure. Krydsreference til DADman manual Ch. 3.]_

1. Download DAD Thunderbolt driverpakken fra [digitalaudio.dk](https://digitalaudio.dk/support).
2. Kør installationsprogrammet og følg instruktionerne på skærmen.
3. Genstart computeren, når du bliver spurgt.
4. Strøm på enheden og tilslut Thunderboltkablet.
5. Åbn DADman - enheden skal fremgå af Enhedslisten.

> **BEMÆRK:** Thunderbolt sikkerhedsindstillinger på macOS kan kræve, at brugeren godkender den nye Thunderbolt enhed ved første forbindelse. Se afsnittet om DADman Installation for detaljer.
...
4. Tilslut enheden til værtscomputeren (Thunderbolt 3 eller Ethernet).
