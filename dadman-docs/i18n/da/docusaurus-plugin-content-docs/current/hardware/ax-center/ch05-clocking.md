...
AX Center understøtter flere ur referencekilder. Den aktive urkilde er valgt i DADman. Kun én enhed i en DADman-session bør være ur master; alle andre enheder bør slave til det.
...
1. I DADman, åbne enhedskonfigurationen for AX Center.
