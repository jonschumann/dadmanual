...
Status MOM. LED não iluminado. Verifique o cabo USB-C entre o MOM e a unidade host. Verifique se o DADman está sendo executado no computador host. Verifique se a unidade do host (AX Center / AX64) está ligada. £[Ch. 3 — Instalação](./ch03-installation) ¶
sr. Spkr. / Src. Botões não funcionais &nbsp;Um perfil de monitor deve ser configurado no DADman. Veja o DADman Manual Ch. 8. £[Ch. 7 — Integração com DADman ](./ch07-dadman-integration) £
├Clock error (Err. Luz de LED litro). Verifique se a fonte de referência externa está presente e na taxa de amostragem correta. Verifique encerramento de relógio de palavras. £[Ch. 5 — Relógio](./ch05-clocking) £
