...
O Penta 720 suporta múltiplas fontes de referência de relógio. A fonte do relógio ativo está selecionada no DADman. Apenas um dispositivo em uma sessão DADman deve ser o mestre do relógio; todos os outros dispositivos devem ser escravos.
...
1. No DADman, abra a configuração do dispositivo para o Penta 720.
