...
Unidade não detectada no DADman 「Verifique se o driver Thunderbolt está instalado. Verifique a classificação do cabo do Thunderbolt (deve ser de 20 Gbps / TB3 avaliado). Verificar configurações de segurança do macOS Thunderbolt. £[Ch. 3 — Instalação](./ch03-installation#34-thunderbolt-driver-installation) ➲
