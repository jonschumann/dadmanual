...
O Centro AX é uma unidade de montagem de pilha de 1U que se monta diretamente em um rack padrão de 19-centímetro com as orelhas de pilha fornecidas.
...
Interno. IEC C14 inlet. 100–240 V AC, 50/60 Hz, intervalo automático.
