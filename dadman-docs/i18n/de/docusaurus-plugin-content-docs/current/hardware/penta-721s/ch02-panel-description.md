...
> **Wie man dieses Kapitel nutzt:** Dieses Kapitel identifiziert jede Steuerung und jeden Konnektor der Penta 721s. Für Signalpegel und Verbindungsverfahren siehe [Ch. 4 — Signalverbindungen](ch04-connections. Für die Bedeutung von LED-Status siehe [Abschnitt 2.3](#23-led-state-reference).
...
_Abbildung 2.1 — Penta 721s Frontplatte. Nummerierte Anrufe entsprechen der unten stehenden Referenztabelle._
...
_Abbildung 2.2 — Penta 721s hintere Panel. Nummerierte Anrufe entsprechen der unten stehenden Tabelle._

> **HINWEIS:** Die hintere Paneele der Penta 721 variiert je nach den eingebauten Erweiterungskarten. Die unten angezeigte Konnektor-Ergänzung spiegelt eine typische Konfiguration wider. Überprüfen Sie das Kartenlayout in Ihrer Einheit, bevor Sie eine Verbindung herstellen.
...
| 5        | \*\*MADI IN \*\*                                                           | BNC, 75                            | MADI Koaxialeingabe. AES10 konform.                                                                                                            | Blau     |
| 6        | **MADI AUS**                                                               | BNC, 75                            | MADI Koaxialausgabe.                                                                                                                                           | Blau     |
| 7        | **Optischer I/O**                                                          | TOSLINK (optisch)    | Optische MADI oder ADAT I/O (kartenabhängig).                                                                                               | Türkis   |
| 8        | **WC/VBB IN**                                                              | BNC, 75                            | Wortuhr oder Video Black Burst Eingabe.                                                                                                                        | Violett  |
| 9        | **WOCHE AUS**                                                              | BNC, 75                            | Wortuhr-Ausgabe.                                                                                                                                               | Violett  |
| 10       | \*\*AES11 IN \*\*                                                          | XLR (weiblich)       | AES11 Digital Audio Referenzsignaleingang.                                                                                                                     | Grün     |
...
| 13       | **SLOT 1** _(typisch: Dante/AES67 I/O)_ | 2× SFP                                  | Erweiterungskarte Slot 1. Mit einer Dante/AES67 I/O-Karte: zwei SFP-Ports für optische oder Kupfer-Dante-Netzwerkverbindungen. | Türkis   |
