...
Die Penta 721s unterstützt mehrere Referenzquellen. Die aktive Uhrenquelle wird in DADman ausgewählt. Nur ein Gerät in einer DADman-Sitzung sollte der Uhrenmeister sein; alle anderen Geräte sollten darauf Slave sein.
...
## 5.4 AES11 / AES Referenz

_[Placeholder — Uhren vom MADI Einbetten oder AES11 Referenzsignal.]_

---

## 5.5 Netzwerk PTP (IEEE 1588)

_[Placeholder — Uhren von ADAT-Einbettung oder Netzwerk-PTP-Quelle.]_

---

## 5.6 Integrierter Sample-Rate Converter (SRC)

_[Placeholder — nur Penta 721s. Beschreiben Sie SRC-Fähigkeiten, unterstützte Datenkonvertierungen und Konfiguration in DADman.]_

Der Penta 721s verfügt über einen integrierten SRC, der Audio-Streams mit unterschiedlichen Abtastraten überbrückt. Dadurch kann er als Begrenzungsgerät zwischen beispielsweise einem 48 kHz Audionetz und einer 96 kHz Sitzung funktionieren.

---

## 5.7 Konfiguration der Uhr in DADman

_[Placeholder — wie man die Uhrquelle auswählt und die Sperre im DADman überprüft. DADman Handbuch Ch. 5.]_

1. Öffnen Sie in DADman die Gerätekonfiguration für die Penta 721s.
