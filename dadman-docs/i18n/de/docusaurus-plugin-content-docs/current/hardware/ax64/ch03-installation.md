...
Der AX64 ist eine 2U-Rackmontage, die direkt in einem 19-Zoll-Rack mit den mitgelieferten Rackohren montiert wird.
...
Intern. IEC C14 inlet. 100–240 V AC, 50/60 Hz, Auto-Ranking. Optionale redundante PSU verfügbar.
...
4. Verbinden Sie die Einheit mit dem Host-Computer (Thunderbolt 3 oder Ethernet).
