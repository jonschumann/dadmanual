...
Der Core 256 ist eine Halbrack-Einheit. Ein 1U-Regal (separat erhältlich) oder das Core 256 Racking Hardware Zubehör sind erforderlich, um es in einem Standard-19-Zoll-Rack montieren zu können.
...
Extern. 12 V DC-Barrel Steckverbinder. Externe PSU geliefert.
...
## 3.4 Installation des Thunderbolt-Treibers

Der DAD Thunderbolt Treiber muss auf dem Host-Computer installiert sein, bevor die Einheit von DADman erkannt wird.

_[Placeholder — Installationsvorgang des Treibers. Cross-Referenz zu DADman Handbuch Ch. 3.]_

1. Laden Sie das DDAD Thunderbolt Treiberpaket von [digitalaudio.dk](https://digitalaudio.dk/support).
2. Führen Sie den Installer aus und folgen Sie den Anweisungen auf dem Bildschirm.
3. Starten Sie den Computer neu, wenn Sie aufgefordert werden.
4. Schalten Sie das Gerät an und verbinden Sie das Thunderbolt-Kabel.
5. DADman öffnen — die Einheit sollte in der Geräteliste erscheinen.

> **HINWEIS:** Thunderbolt Sicherheitseinstellungen auf macOS erfordern, dass der Benutzer das neue Thunderbolt Gerät bei der ersten Verbindung genehmigen muss. Weitere Informationen finden Sie im Kapitel DADman Installation.
...
4. Verbinden Sie die Einheit mit dem Host-Computer (Thunderbolt 3).
