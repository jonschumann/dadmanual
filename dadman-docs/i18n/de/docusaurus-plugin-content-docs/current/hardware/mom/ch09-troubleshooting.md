...
\| MOM Stat. LED nicht beleuchtet | Verifizieren Sie USB-C Kabel zwischen MOM und Host-Einheit. Verify DADman läuft auf dem Host-Computer. Host Einheit verifizieren (AX Center / AX64) ist eingeschaltet. | [Ch. 3 — Installation](./ch03-installation) |
\| Spkr. / Src. Tasten nicht funktionell | Ein Monitorprofil muss in DADman konfiguriert werden. Siehe DADman Manual Ch. 8. | [Ch. 7 — DADman Integration](./ch07-dadman-integration) |
