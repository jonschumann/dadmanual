...
| 6        | **WC/VBB IN**                                    | BNC, 75                                   | Wortuhr oder Video Black Burst Eingabe. Akzeptiert Wortuhr (1×, 256×, oder Video-Sync-Format). Schließen Sie die 75  -Beendigung auf dem letzten Gerät in einer Wort-Uhr-Kette an.                                                                                                                | <span style={{display:'inline-block',width:'10px',height:'10px',borderRadius:'50%',margin:'0 6px',background:'#7C3AED'}}></span> |
| 7        | **WOCHE AUS**                                    | BNC, 75                                   | Wortuhr-Ausgabe. Gibt die aktuelle Sync-Referenz der Einheit als Wort-Uhr-Signal aus.                                                                                                                                                                                                                                                     | <span style={{display:'inline-block',width:'10px',height:'10px',borderRadius:'50%',margin:'0 6px',background:'#7C3AED'}}></span> |
| 8        | \*\*MADI IN \*\*                                 | BNC, 75                                   | MADI input (coaxial). Akzeptiert AES10 MADI im 56- oder 64-Kanal-Rahmenformat. Bei 96 kHz ist die maximale Kanalanzahl 32.                                                                                                                                                                             | <span style={{display:'inline-block',width:'10px',height:'10px',borderRadius:'50%',margin:'0 6px',background:'#1D4ED8'}}></span> |
| 9        | **MADI AUS**                                     | BNC, 75                                   | MADI output (coaxial). Überträgt MADI im konfigurierten Frame Format und Abtastrate.                                                                                                                                                                                                                                   | <span style={{display:'inline-block',width:'10px',height:'10px',borderRadius:'50%',margin:'0 6px',background:'#1D4ED8'}}></span> |
...
> **NOTICE — Terminierung der Wortuhr:** Der WC/VBB IN Port muss beendet werden (75  ), wenn das AX Center das letzte Gerät einer Wort-Uhr-Kette ist. Der Terminierungsschalter befindet sich neben dem BNC-Anschluss.
