...
\| Einheit nicht im DADman erkannt | Verify Thunderbolt Treiber ist installiert. Überprüfen Sie die Thunderbolt-Kabelbewertung (muss 20 Gbps / TB3 bewertet). Überprüfen Sie die macOS Thunderbolt Sicherheitseinstellung. | [Ch. 3 — Installation](./ch03-installation#34-thunderbolt-driver-installation) |
