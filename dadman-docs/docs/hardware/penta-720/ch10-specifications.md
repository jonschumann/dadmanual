---
id: penta-720/ch10-specifications
...
| Maximum audio channels | Up to 720 channels (card-dependent) |
...
| Parameter | Specification |
|-----------|--------------|
| Supply | Internal. IEC C14 inlet. 100–240 V AC, 50/60 Hz, 0.45–0.20 A. Optional redundant PSU. |
...
- [App. A — Connector Pinouts](./penta-720/appa-connector-pinouts)
- [App. C — Mechanical Drawings](./penta-720/appc-mechanical-drawings)
