...
| 13 | **SLOT 1** *(typical: Dante/AES67 I/O)* | 2× SFP | Expansion card slot 1. When fitted with a Dante/AES67 I/O card: two SFP ports for optical or copper Dante network connections. Slot content varies by configuration. |
