...
> **Before you begin:** Read [Front Matter — Safety & Conventions](./penta-720/fm-safety) before installing this unit.
...
2. Apply power.
3. Observe front-panel LEDs — see [Ch. 2 — Panel Description](./penta-720/ch02-panel-description) for expected LED states.
...
- [Front Matter — Safety](./penta-720/fm-safety)
