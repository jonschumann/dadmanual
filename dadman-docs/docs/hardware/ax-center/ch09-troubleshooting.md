...
| Unit not detected in DADman | Verify Thunderbolt driver is installed. Check Thunderbolt cable rating (must be 20 Gbps / TB3 rated). Check macOS Thunderbolt security setting. | [Ch. 3 — Installation](./ch03-installation#34-thunderbolt-driver-installation) |
...
- [Ch. 2 — Panel Description](./ax-center/ch02-panel-description) — LED state reference
- [Ch. 5 — Clocking](./ax-center/ch05-clocking)
