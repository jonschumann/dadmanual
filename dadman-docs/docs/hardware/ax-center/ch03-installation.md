---
id: ax-center/ch03-installation
...
> **Before you begin:** Read [Front Matter — Safety & Conventions](./ax-center/fm-safety) before installing this unit.
...
The AX Center is a 1U rackmount unit that mounts directly in a standard 19-inch rack with the supplied rack ears.
...
Internal. IEC C14 inlet. 100–240 V AC, 50/60 Hz, auto-ranging.
...
2. Apply power.
3. Observe front-panel LEDs — see [Ch. 2 — Panel Description](./ax-center/ch02-panel-description) for expected LED states.
...
- [Front Matter — Safety](./ax-center/fm-safety)
- [Ch. 2 — Panel Description](./ax-center/ch02-panel-description)
