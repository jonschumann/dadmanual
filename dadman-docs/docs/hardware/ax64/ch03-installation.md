...
> **Before you begin:** Read [Front Matter — Safety & Conventions](./ax64/fm-safety) before installing this unit.
...
*[Placeholder — driver installation procedure. Cross-reference to DADman manual Ch. 3.]*
...
2. Apply power.
3. Observe front-panel LEDs — see [Ch. 2 — Panel Description](./ax64/ch02-panel-description) for expected LED states.
...
- [Front Matter — Safety](./ax64/fm-safety)
- [Ch. 2 — Panel Description](./ax64/ch02-panel-description)
