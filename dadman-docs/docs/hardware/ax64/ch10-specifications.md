...
| Primary host connection | Thunderbolt 3 or Ethernet |
| Maximum audio channels | Up to 64×64 analogue channels (card-dependent) |
...
| Parameter | Specification |
|-----------|--------------|
| Supply | Internal. IEC C14 inlet. 100–240 V AC, 50/60 Hz, auto-ranging. Optional redundant PSU available. |
...
- [App. A — Connector Pinouts](./ax64/appa-connector-pinouts)
- [App. C — Mechanical Drawings](./ax64/appc-mechanical-drawings)
