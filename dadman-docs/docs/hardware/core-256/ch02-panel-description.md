...
> **How to use this chapter:** This chapter identifies every control and connector on the Core 256. For signal levels and connection procedures, see [Ch. 4 — Signal Connections](./core-256/ch04-connections). For LED state meanings, see [Section 2.3](#23-led-state-reference) and [Ch. 6 — Operation](./core-256/ch06-operation).
...
- [Ch. 4 — Signal Connections](./core-256/ch04-connections) — Signal levels and connection procedures
- [Ch. 6 — Operation](./core-256/ch06-operation) — Controls and display operation
