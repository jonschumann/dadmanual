...
| Primary host connection | Thunderbolt 3 |
| Maximum audio channels | Up to 256×256 channels at 48 kHz |
...
| Parameter | Specification |
|-----------|--------------|
| Supply | External. 12 V DC barrel connector. External PSU supplied. |
...
- [App. A — Connector Pinouts](./core-256/appa-connector-pinouts)
- [App. C — Mechanical Drawings](./core-256/appc-mechanical-drawings)
